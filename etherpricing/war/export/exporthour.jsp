...
<%!
private static String printCsvLine(Hour entity) {
 ...
 * convert to csv
 */
private static StringBuilder toCsv(List<Hour> list) {
	StringBuilder sb = new StringBuilder();
	for (Hour entity:list) {
		// convert to csv
...
if (!enable) { 
	...
	if (paramStart != null && !"".equals(paramStart)
		...
		List<Hour> entities = ObjectifyService.ofy()
		          .load()
		          .type(Hour.class)
